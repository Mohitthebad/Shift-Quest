...
export const ProjectsPortfolioSection: React.FC = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      text: "Helping organizations build future-ready workforces through AI-powered talent strategies, leadership development, and workforce planning that improve agility, productivity, and long-term business performance.",
      status: "Workforce Future-Ready",
      impact: "Enterprise Workforce Strategy & Talent Transformation",
